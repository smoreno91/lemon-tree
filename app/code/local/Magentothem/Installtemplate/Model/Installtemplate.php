...
class Magentothem_Installtemplate_Model_Installtemplate extends Mage_Core_Model_Abstract {
    ...
    public function saveTemplateConfig(int $store) {
		...
		Mage::getConfig()->saveConfig('design/package/name', 'elise', $scope, $store);
        Mage::getConfig()->saveConfig('design/theme/default', 'ma_elise3', $scope, $store);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'elise_home', $scope, $store);
		Mage::getConfig()->saveConfig('design/theme/default', 'ma_elise3', 'default', 0);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'elise_home', 'default', 0);
