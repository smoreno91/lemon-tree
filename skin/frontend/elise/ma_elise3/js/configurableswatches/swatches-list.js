...
var ConfigurableSwatchesList = {
    ...
    {
        var that = this;
        $jq('.configurable-swatch-list li').each(function() {
    ...
    handleSwatchSelect: function($swatch)
    {
        ...
        $jq.each(this.swatchesByProduct[productId], function(key, $productSwatch) {
...
$jq(document).on('configurable-media-images-init', function(){
