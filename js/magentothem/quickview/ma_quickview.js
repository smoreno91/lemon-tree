...
function initQuickButton(element) {
    ...
    $jq(element + ' a.product-image').each(function(path) {
        ...
        if(rel == null || rel == '') {
            ...
            paths[count] = subpath;
            $jq(this).closest("div.item-inner").children('.des-container').children(".box-hover" ).children(".box-hover-inner" )
									.append('<div class="qv-button-container"><a ' +'class="qv-e-button btn-quickview-' + count + '" href="javascript:void(0);"><em '+'class="tooltip">'+'QuickView</em>' + 'Quick View</a></div>');
